...
Audience: Developers extending the mobile app.
Status: active.
Applies to: SelfHelp2 Expo/React Native mobile app (`sh-selfhelp_mobile`).
Last verified: 2026-06-03.
Source of truth: Mobile source code, the shared package contracts, and the established patterns these recipes follow.
...
- [add-instance.md](add-instance.md) - Add a new SelfHelp customer instance.
